...
public class GameUI : MonoBehaviour
{
	...
	public void InitGame()
	{
		...
		StartOverlay();
		//switch (PlayerObject.Local.Controller.Team)
		//{
		//    case Teams.A:
		//		TeamAOverlay();
		//		break;
	...
	public void UpdateTaskUI()
	{
		...
		//{
		//	byte numTotal = GameManager.Instance.taskDisplayAmounts[taskItem.Info];
		//	int count = numTotal - tasks.Count(ts => ts.taskUI.task == taskItem.Info);
	...
	public void WinOverlay(Teams winTeam)
	{
		SetOverlay($"Team{winTeam.ToString()} Win", PlayerMovement.Local.Team != winTeam ? "Lose" : "Victory");
		messageNicknameText.text = "";
		messageScreenPanel.color = PlayerObject.Local.GetColor;
		messageScreenGlow.color = Color.blue;
